import os,json
n=0
for root,dirs,files in os.walk('/home/weitianc/ClawBox'):
  for fn in files:
    if not fn.endswith('.jsonl') or '15five' not in fn: continue
    ...
    print('CHECK',p,os.path.getsize(p),len(starts),good)
    if good: raise SystemExit
    n+=1
print('scanned',n)
