# Historical Kubernetes recovery attempt — do not execute

This superseded runbook records the previous agent's incorrect deployment path.
Its commands are retained as fault evidence only. Use
[standalone recovery](../tiered-oracle-recovery.md) for current work.
