...
exec .venv/bin/python -m clawbox.experiments.worker \
  --spec /home/weitianc/clawbox-tiered-study-20260907/gates/tiered-policy-c4-v1.yaml \
  --run-id gate-tiered-policy-c4-v1 --attempt-id gate-tiered-policy-c4-v1 \
  --task-uid gate-tiered-policy-c4-v1
